...
Python is where claims about chemistry live. TypeScript owns the eDSL, schema
tooling, editor, and browser playground; this package owns validation and
semantics.

```bash
python3 demo.py                                  # end to end, ~1s
python3 -m unittest discover -s tests -v         # 77 tests, ~0.7s
```
...
Molecule templates and ports; atom-mapped reaction transforms; resonance,
